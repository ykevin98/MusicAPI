...
namespace MusicData.Repositories
{
    ...
    public class Repository<T> : IRepository<T> where T : class
    {
        ...
        public IEnumerable<T> QueryWithRawSqlOrStoreProcedure(string sql, params System.Data.SqlClient.SqlParameter[] parameters)
        {
            IEnumerable<T> result = null;
        ...
        public IQueryable<T> QueryWithRawSqlOrStoreProcedureAsIQueryable(string sql, params System.Data.SqlClient.SqlParameter[] parameters)
        {
            IQueryable<T> result = null;
        ...
        public int NonQueryRawSqlOrStoreProcedure(string sql, params System.Data.SqlClient.SqlParameter[] parameters)
        {
            int count = 0;
